...
#define KEY_SWITCH_TEXTURE  ('t') // Key used to toggle RGB //
#define KEY_DEC_SCALE_TEXT  ('s') // Key used to toggle RGB //
#define KEY_INC_SCALE_TEXT  ('d') // Key used to toggle RGB //
#define KEY_DEC_TURB        ('f') // Key used to toggle RGB //
#define KEY_INC_TURB        ('g') // Key used to toggle RGB //
...
void keyboard(unsigned char key, int x, int y)
{
    ...
    switch(lower_key)
    {
        ...
        case KEY_DECREASE:
            ...
            glutPostRedisplay();
            break;
        case KEY_SWITCH_TEXTURE:
            _model.switchTexture();
            glutPostRedisplay();
            break;
        case KEY_DEC_SCALE_TEXT:
            _model.decreaseScaleTexture();
            glutPostRedisplay();
            break;
        case KEY_INC_SCALE_TEXT:
            _model.increaseScaleTexture();
            glutPostRedisplay();
            break;
        case KEY_DEC_TURB:
            _model.decreaseTurb();
